                    ...
                    <div class="flex">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="media-text">
                                ...
                                Aenean dignissim sed ante eget dapibus. Sed
                                dapibus nulla elementum, rutrum neque eu,
                                gravida neque.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="media-text">
                                ...
                                Aenean dignissim sed ante eget dapibus. Sed
                                dapibus nulla elementum, rutrum neque eu,
                                gravida neque. Fusce condimentum cursus mauris
                                et ornare. Mauris fermentum mi id sollicitudin
                                viverra. Aenean dignissim sed ante eget dapibus.
                                Sed dapibus nulla elementum, rutrum neque eu,
                                gravida neque.
                            </p>
                        </div>
                    </div>
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex">
                        <div
                            class="flex-1 ltr:mr-4 rtl:ml-4 ltr:text-right rtl:text-left">
                            <h4 class="font-semibold text-lg mb-2 text-primary">
                                Heading
                            </h4>
                            <p class="media-text">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="media-text">
                                        Fusce condimentum cursus mauris et
                                        ornare. Mauris fermentum mi id
                                        sollicitudin viverra. Aenean dignissim
                                        sed ante eget dapibus. Sed dapibus nulla
                                        elementum, rutrum neque eu, gravida
                                        neque.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="mb-5">
                    <div class="flex">
                        ...
                        <div class="flex-1">
                            ...
                            <ul
                                class="flex space-x-4 rtl:space-x-reverse font-bold">
                                <li>
                                    <a
                                        href="javascript:;"
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-1">
                            <h4 class="font-semibold text-lg mb-2 text-primary">
                                Heading
                                <span
                                    class="badge bg-primary ltr:float-right rtl:float-left"
                                    >Web Designer</span
                                >
                            </h4>
                            <p class="media-text">
