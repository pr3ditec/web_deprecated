    ...
    <div>
        ...
        <div>
            <div class="pt-5 space-y-8">
                ...
                <div class="panel">
                    <h5
                        class="font-semibold text-lg dark:text-white-light mb-5">
                        Lightbox
                    </h5>
                    <div class="mb-5">
                        <div class="flex mb-5">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="media-text">
                                    Caption, slideshow, thumbnails and
                                    fullscreen buttons, tap to toggle controls
                                </p>
                            </div>
                        </div>
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="media-text">
                                    No caption, no slideshow, no thumbnails, no
                                    fullscreen, tap to close
                                </p>
                            </div>
                        </div>
                        <div
                            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-10">
                            <template v-for="(item, i) in items" :key="i">
                                <a
                                    href="javascript:;"
                                    :class="{
                                        'md:row-span-2 md:col-span-2': i == 3,
                                    }"
                                    @click="
                                        index = i;
                                        visible = true;
