    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div
                ...
                ><a
                    href="https://www.npmjs.com/package/vue-height-collapsible"
                    target="_blank"
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="space-y-2 font-semibold">
                            <div
                                class="border border-[#d3d3d3] rounded dark:border-[#1b2e4b]">
                                <button
                                    type="button"
                                    class="p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b]"
                                    :class="{
                                        '!text-primary': accordians1 === 1,
                                    }"
                                    @click="
                                        accordians1 === 1
                                            ? (accordians1 = null)
                            ...
                            <div
                                class="border border-[#d3d3d3] dark:border-[#1b2e4b] rounded">
                                <button
                                    type="button"
                                    class="p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b]"
                                    :class="{
                                        '!text-primary': accordians1 === 2,
                                    }"
                                    @click="
                                        accordians1 === 2
                                            ? (accordians1 = null)
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div
                            class="border border-[#d3d3d3] dark:border-[#3b3f5c] rounded font-semibold">
                            <div
