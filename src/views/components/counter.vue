    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div
                ...
                ><a
                    href="https://www.npmjs.com/package/vue-countup-v3"
                    target="_blank"
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div class="panel">
                    ...
                    <div
                        class="mb-5 grid grid-cols-3 justify-items-center gap-3 max-w-[900px] mx-auto">
                        <div>
                            <div
                                ...
                                <count-up
                                    class="text-primary text-xl sm:text-3xl text-center"
                                    :start-val="0"
                                    :end-val="710"
                                    :duration="7"></count-up>
                            </div>
