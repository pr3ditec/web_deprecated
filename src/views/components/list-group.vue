            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div
                        ...
                        <div
                            class="border-b border-[#e0e6ed] dark:border-[#1b2e4b] px-4 py-2.5">
                            Cras justo odio
                        </div>
                        <div
                            class="border-b border-[#e0e6ed] dark:border-[#1b2e4b] px-4 py-2.5">
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div
                        ...
                        <a
                            href="javascript:;"
                            class="px-4 py-2.5 hover:bg-[#eee] dark:hover:bg-[#eee]/10"
                ...
                <div class="mb-5">
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="ltr:mr-2 rtl:ml-2.5 mt-0.5 text-primary">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                        ...
                        <div
                            ...
                            <div
                                class="ltr:mr-2 rtl:ml-2.5 mt-0.5 text-white group-hover:text-primary">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                        ...
                        <div
                            class="flex px-4 py-2.5 hover:bg-[#eee] dark:hover:bg-[#eee]/10">
                            <div
                                class="ltr:mr-2 rtl:ml-2.5 mt-0.5 text-primary">
                                <svg
                                    width="24"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <label
                                ...
                                >List groups are a flexible and powerful
                                component for displaying simple.
                                <span
                                    class="badge bg-secondary my-auto ltr:ml-3 rtl:mr-3 hover:top-0"
                                    >Project</span
                                ></label
                            >
                        </div>
                        <div
                            ...
                            <label
                                ...
                                component for displaying simple.
                                <span
                                    class="badge bg-info my-auto ltr:ml-3 rtl:mr-3 hover:top-0"
                                    >Urgent</span
                                ></label
                            >
                        </div>
                        <div
                            ...
                            <label
                                ...
                                component for displaying simple.
                                <span
                                    class="badge bg-success my-auto ltr:ml-3 rtl:mr-3 hover:top-0"
                                    >Success</span
                                ></label
                            >
                        </div>
