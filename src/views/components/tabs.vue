    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div
                ...
                ><a
                    href="https://headlessui.com/vue/tabs"
                    target="_blank"
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList class="flex flex-wrap mt-3">
                            ...
                            <Tab as="template" disabled>
                                <a
                                    href="javascript:;"
                                    class="p-3.5 py-2 -mb-[1px] block rounded pointer-events-none text-white-light dark:text-dark"
                                    >Disabled</a
                                >
                            </Tab>
                        </TabList>
                        ...
                        <TabList class="flex flex-wrap mt-3 gap-2">
                            <Tab v-slot="{ selected }" as="template">
                                <a
                                    ...
                                    :class="{
                                        'bg-warning text-white': selected,
                                    }">
                                    <svg
                                        width="24"
                                        height="24"
                        ...
                        <TabPanels class="flex-1 text-sm">
                            ...
                            <TabPanel>
                                <blockquote
                                    ...
                                    <div class="flex items-start">
                                        <p
                                            class="not-italic text-[#515365] text-sm dark:text-white-dark m-0">
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        ...
                        <TabPanels
                            class="p-4 flex-1 text-sm border border-white-light border-t-0 dark:border-[#191e3a]">
                        ...
                        <TabList class="flex flex-wrap mt-3 mb-5">
                            <Tab v-slot="{ selected }" as="template">
                                <a
                                    ...
                                    :class="{
                                        '!border-secondary text-secondary dark:bg-[#191e3a]':
                                            selected,
                                    }">
                                    <svg
                                        width="24"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
                        <div class="mx-10 mb-5 sm:mb-0">
                            <TabList
                                class="w-24 m-auto text-center font-semibold">
                                <Tab v-slot="{ selected }" as="template">
                                    <a
                                        href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList
                            class="flex flex-wrap justify-between mt-3 border-b border-white-light dark:border-[#191e3a] text-center">
                            <Tab v-slot="{ selected }" as="template">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList
                            class="flex flex-wrap justify-between mt-3 space-x-2 rtl:space-x-reverse text-center">
                            <Tab v-slot="{ selected }" as="template">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList
                            class="flex flex-wrap justify-center mt-3 space-x-2 rtl:space-x-reverse">
                            <Tab v-slot="{ selected }" as="template"
                                ><a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList
                            class="flex flex-wrap justify-end mt-3 space-x-2 rtl:space-x-reverse">
                            <Tab v-slot="{ selected }" as="template">
                                <a
                                    href="javascript:;"
                                    class="p-3.5 py-2 -mb-[1px] block hover:bg-info rounded hover:text-white !outline-none transition duration-300"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList
                            class="flex flex-wrap justify-center mt-3 mb-5 space-x-3 rtl:space-x-reverse">
                            <Tab v-slot="{ selected }" as="template">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
                        <div class="mx-10 mb-5 sm:mb-0">
                            <TabList
                                class="flex flex-col justify-center m-auto space-y-3 w-24">
                                <Tab v-slot="{ selected }" as="template">
                                    <a
                                        href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
                        <TabList
                            class="ltr:pr-4 rtl:pl-4 space-y-2 sm:flex-[0_0_20%] mb-5 sm:mb-0">
                            <Tab v-slot="{ selected }" as="template"
                                ><a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup
                        as="div"
                        class="mb-5 flex flex-col sm:flex-row sm:gap-4">
                        <TabList
                            class="space-y-2 sm:flex-[0_0_20%] mb-5 sm:mb-0 sm:order-1">
                            <Tab v-slot="{ selected }" as="template"
                                ><a
                                    href="javascript:;"
                                    class="p-3.5 py-2 block rounded-md hover:bg-success hover:text-white transition-all duration-300 !outline-none"
