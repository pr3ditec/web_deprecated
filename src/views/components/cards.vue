            ...
            <div class="panel">
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="py-7 px-6">
                            <div
                                class="bg-[#3b3f5c] mb-5 inline-block p-3 text-[#f1f2f3] rounded-full">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                            ...
                            <h5
                                class="text-[#3b3f5c] text-xl font-semibold mb-4 dark:text-white-light">
                                Simple
                            </h5>
                            <p class="text-white-dark">
                                Mauris nisi felis, placerat in volutpat id,
                                varius et sapien.
                            </p>
                        </div>
                    </div>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="py-7 px-6">
                            ...
                            <p class="text-white-dark">
                                Etiam sed augue ac justo tincidunt posuere.
                                Vivamus euismod eros, nec risus malesuada.
                            </p>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="text-center text-black-light">
                            <div
                                class="mb-5 w-20 h-20 rounded-full overflow-hidden mx-auto">
                                <img
                            ...
                            <h5
                                class="text-white text-[15px] font-semibold mb-2">
                                Luke Ivory
                            </h5>
                            <p>Manager</p>
                            <div
                                class="flex justify-center items-center text-[#e2a03f] my-4">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                            ...
                            <p class="font-semibold italic">
                                Maecenas nec mi vel lacus condimentum rhoncus
                                dignissim egestas orci. Integer blandit porta
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="text-black-light">
                            ...
                            <div class="flex">
                                <div
                                    class="mb-5 w-14 h-14 rounded-full overflow-hidden mx-auto">
                                    <img
                                        src="/assets/images/profile-34.jpeg"
                                        alt=""
                                        class="w-full h-full object-cover" />
                                ...
                                <div class="flex-1 ltr:pl-4 rtl:pr-4">
                                    <h5
                                        class="text-white text-[15px] font-semibold mb-1">
                                        Luke Ivory
                                    </h5>
                                    <p>Manager</p>
                                </div>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="text-[#515365] dark:text-white-light">
                            <p class="font-semibold italic mb-5">
                                Maecenas nec mi vel lacus condimentum rhoncus
                                dignissim egestas orci. Integer blandit porta
                                placerat. Vestibulum in ultricies.
                            </p>
                            <div class="flex">
                                <div class="flex-1">
                                    <h5
                                        class="text-[#3b3f5c] text-[15px] font-bold mb-1.5 dark:text-white-light">
                                        Luke Ivory
                                    </h5>
                                    <p class="text-white-dark mb-1.5">
                                        Manager
                                    </p>
                                    <div
                                        class="flex justify-start items-center text-[#e2a03f]">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="text-center font-semibold">
                            <h5
                                class="text-white text-xl font-bold mb-5 dark:text-white-light">
                                Rating
                            </h5>
                            <p class="text-white mb-5 text-base">(4.3)</p>
                            <div
                                class="flex justify-center items-center gap-1 text-[#e2a03f]">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                ...
                                <span class="text-white ltr:ml-1 rtl:mr-1"
                                    >(94)</span
                                >
                            </div>
                        </div>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="flex justify-between mb-5">
                            <h6
                                class="text-[#0e1726] font-semibold text-base dark:text-white-light">
                                Placed Order
                            </h6>
                            <span
                                class="badge bg-primary/10 text-primary py-1.5 dark:bg-primary dark:text-white"
                                >IN PROGRESS</span
                            >
                        </div>
                        <div
                            class="flex items-center justify-start -space-x-3 rtl:space-x-reverse mb-5">
                            <img
                        ...
                        <div class="text-right">
                            ...
                            <div
                                ...
                                <div
                                    class="rounded-full bg-primary h-full"
                                    style="width: 60%"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="py-7 px-6">
                            ...
                            <p class="text-white-dark">
                                Vestibulum vestibulum tortor ut eros tincidunt,
                                ut rutrum elit volutpat.
                            </p>
                            <div
                                ...
                                <div class="flex items-center font-semibold">
                                    <div
                                        class="w-9 h-9 rounded-full overflow-hidden inline-block ltr:mr-2 rtl:ml-2.5 shrink-0">
                                        <span
                                            class="flex w-full h-full items-center justify-center bg-[#515365] text-[#e0e6ed]"
                                            >AG</span
                                        >
                                    </div>
                                    <div
                                        class="text-[#515365] dark:text-white-dark">
                                        Luke Ivory
                                    </div>
                                </div>
                                <div class="flex font-semibold">
                                    <div
                                        class="text-primary flex items-center ltr:mr-3 rtl:ml-3">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
