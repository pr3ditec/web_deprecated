                        ...
                        <template v-for="(item, i) in items" :key="i">
                            <swiper-slide>
                                <img
                                    ...
                                    alt="" />
                                <div
                                    class="absolute z-[999] text-white top-1/4 ltr:left-12 rtl:right-12">
                                    <div
                                        class="sm:text-3xl text-base font-bold">
                                        This is blog Image
                                    </div>
                                    <div
                                        class="sm:mt-5 mt-1 w-4/5 text-base sm:block hidden font-medium">
                        ...
                        <template v-for="(item, i) in items" :key="i">
                            <swiper-slide>
                                ...
                                <div
                                    ...
                                    <div
                                        class="sm:text-xl text-base font-medium">
                                        Lorem Ipsum is simply dummy text of the
                                        printing.
                                    </div>
                                </div>
