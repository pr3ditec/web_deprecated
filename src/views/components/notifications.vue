...
&lt;/script&gt;
                ...
                <div class="panel lg:row-span-2">
                    ...
                    <div class="mb-5">
                        <h6
                            class="font-semibold text-base dark:text-white-light mb-3 text-center">
                            Top Position
                        </h6>
                        <div
                            class="flex items-center justify-center mb-10 gap-2">
                            <button
                                type="button"
