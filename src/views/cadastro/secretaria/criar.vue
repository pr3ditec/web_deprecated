...
<template>
    <div class="flex flex-col items-center gap-5 mt-4 w-1/2">
        ...
        <div class="w-full gap-0">
            ...
            <input class="form-input" type="text" placeholder="Ex.: secretaria@sauvi.com"
        ...
        <div class="w-full gap-0">
            ...
            <input class="form-input" v-mask="'##/##/####'" type="text" placeholder="Ex.: 00/00/0000"
        ...
        <div class="w-full gap-0">
            ...
            <input class="form-input" v-bind:class="classePassword" v-on:keyup="$event => compararSenhas($event)"
                type="password" />
            <span class="flex flex-col items-start text-danger text-xs align-start mt-0 pt-0"
                v-show="classePassword['border border-red-600']">Senhas nao correspondem</span>
        </div>

        <div class="flex flex-col items-center font-semibold mt-6">
            <button class="btn btn-primary w-80" v-on:keyup.enter="cadastrarSecretaria"
                @click="cadastrarSecretaria">Cadastrar</button>
        </div>
