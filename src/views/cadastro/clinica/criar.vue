    ...
    <div class="grid space-y-6 grid-cols-1 items-center w-full">
        ...
        <div class="flex flex-col items-center gap-5 mt-4">
            ...
            <div class="w-1/2">
                ...
                <input class="form-input" v-mask="'#####-###'" type="text" placeholder="Ex.: 87560-000"
                    v-on:input="$event => clinicaEnderecoFormData.cep = $event.target.value" />
            </div>

            <!-- Rua -->
            <div class="w-1/2">
                <label class="capitalize" for="groupFname">{{ $t('street') }}</label>
                <input class="form-input" type="text" placeholder="Ex.: Rua mercelo azevedo"
            ...
            <div class="w-1/2">
                ...
                <input class="form-input" v-mask="'#####'" type="text" placeholder="Ex.: 233"
            ...
            <div class="w-1/2">
                ...
                <input class="form-input" type="text" placeholder="Ex.: Apto 12"
