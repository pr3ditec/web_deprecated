        ...
        <div class="w-full md:w-1/3">
            ...
            <div class="mb-5">
                <div class="flex flex-col justify-center items-center">
                    ...
                    <p class="font-semibold text-dark text-xl">
                        {{ dadosUsuario.nome }}
                    </p>
                </div>
                <ul
                    ...
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <div>
                            ...
                            <span
                                v-show="
                                    habilitarNovaSenha &&
                                    formUsuario.antiga_senha.length > 0
                                "
                                class="text-danger text-sm mt-0 lowercase"
                                >{{ $t("password-short") }}</span
                            >
                        </div>
                        <!-- SENHA ANTIGA -->
                        ...
                        <div class="sm:col-span-2 mt-3">
                            <button
                                ...
                                @click="$emit('update-user', formUsuario)">
                                {{ $t("update") }}
                            </button>
                        </div>
                        <!-- BUTTON FORM -->
