                        ...
                        <div>
                            <form
                                ...
                                <div class="flex flex-col sm:flex-row">
                                    <div
                                        class="ltr:sm:mr-4 rtl:sm:ml-4 w-full sm:w-2/12 mb-5">
                                        <img
                                    ...
                                    <div
                                        class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                <input
                                                    ...
                                                    class="form-checkbox" />
                                                <span
                                                    class="text-white-dark relative checked:bg-none"
                                ...
                                <div class="panel">
                                    <div class="mb-5">
                                        ...
                                        <p>
                                            ...
                                            starting with scheduled payment and
                                            will be refelected on your next
                                            invoice.
                                        </p>
                                    </div>
                                    <div class="mb-5">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <h6
                                                    class="text-[#515365] font-bold dark:text-white-dark text-[15px]">
                                                    Address #1
                                                    <span
                                                        class="block text-white-dark dark:text-white-light font-normal text-xs mt-1"
                                                        >2249 Caynor Circle, New
                                                        Brunswick, New
                                                        Jersey</span
                                                    >
                                                </h6>
                                    ...
                                    <div class="mb-5">
                                        <div
                                            ...
                                            <div
                                                class="flex items-start justify-between py-3">
                                                <div
                                                    class="flex-none ltr:mr-4 rtl:ml-4">
                                                    <img
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                <div class="panel">
                                    ...
                                    <div class="mb-5">
                                        <form>
                                            <div
                                                class="mb-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                            ...
                                            <div
                                                class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-5">
                        ...
                        <div class="switch">
                            <div
                                ...
                                <div class="panel space-y-5">
                                    ...
                                    <p>
                                        Download your Summary, Task and Payment
                                        History Data
                                    </p>
                                    <button
                                        type="button"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                ...
                                <div class="panel space-y-5">
                                    ...
                                    <p>
                                        When enabled, press
                                        <span class="text-primary">ctrl</span>
                                        for help
                                    </p>
                                    <label class="w-12 h-6 relative">
                                        <input
                                ...
                                <div class="panel space-y-5">
                                    ...
                                    <p>
                                        Display
                                        <span class="text-primary">Ads</span> on
                                        your dashboard
                                    </p>
                                    <label class="w-12 h-6 relative">
                                        <input
                        ...
                        <div class="switch">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                <div class="panel space-y-5">
                                    ...
                                    <p>
                                        Remove the active resource from the
                                        cache without waiting for the
                                        predetermined cache expiry time.
                                    </p>
                                ...
                                <div class="panel space-y-5">
                                    ...
                                    <p>
                                        ...
                                        messages, notifications for up to 24
                                        hours.
                                    </p>
                                    <label class="w-12 h-6 relative">
                                        <input
                                ...
                                <div class="panel space-y-5">
                                    ...
                                    <p>
                                        Once you delete the account, there is no
