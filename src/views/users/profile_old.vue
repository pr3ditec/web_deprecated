...
<template>
    <div>
        ...
        <div class="pt-5">
            <div
                class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
                <div class="panel">
                ...
                <div class="panel lg:col-span-2 xl:col-span-3">
                    ...
                    <div class="mb-5">
                        <div
                            class="table-responsive text-[#515365] dark:text-white-light font-semibold">
                            <table class="whitespace-nowrap">
                                ...
                                <tbody class="dark:text-white-dark">
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                                <div
                                                    class="bg-danger rounded-full w-[29.56%]"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                                <div
                                                    class="bg-info rounded-full w-1/2"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                                <div
                                                    class="bg-warning rounded-full w-[39%]"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                                <div
                                                    class="bg-success rounded-full w-[78.03%]"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                                <div
                                                    class="bg-secondary rounded-full w-full"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                                <div
                                                    class="bg-danger rounded-full w-[19.15%]"></div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                                <div
                                                    class="bg-primary rounded-full w-[60.55%]"></div>
                                            </div>
                                        </td>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="panel">
                    ...
                    <div class="space-y-4">
                        <div
                            class="border border-[#ebedf2] rounded dark:bg-[#1b2e4b] dark:border-0">
                            <div
                                class="flex items-center justify-between p-4 py-2">
                                <div
                                ...
                                <div
                                    ...
                                    <h6
                                        class="text-white-dark text-[13px] dark:text-white-dark">
                                        Income
                                        <span
                                    ...
                                    <p
                                        class="ltr:ml-auto rtl:mr-auto text-secondary">
                                        90%
                                    </p>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                class="flex items-center justify-between p-4 py-2">
                                <div
                                    class="grid place-content-center w-9 h-9 rounded-md bg-info-light dark:bg-info text-info dark:text-info-light shrink-0">
                                    <svg
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                ...
                                <div
                                    ...
                                    <p
                                        class="ltr:ml-auto rtl:mr-auto text-info">
                                        65%
                                    </p>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p
                                        class="ltr:ml-auto rtl:mr-auto text-warning">
                                        80%
                                    </p>
                                </div>
                            </div>
                ...
                <div class="panel">
                    ...
                    <div class="group">
                        <ul
                            class="list-inside list-disc text-white-dark font-semibold mb-7 space-y-2">
                            <li>10,000 Monthly Visitors</li>
                            <li>Unlimited Reports</li>
                            <li>2 Years Data Storage</li>
                        </ul>
                        <div
                            class="flex items-center justify-between mb-4 font-semibold">
                            <p
                        ...
                        <div
                            class="rounded-full h-2.5 p-0.5 bg-dark-light overflow-hidden mb-5 dark:bg-dark-light/10">
                            <div
                                class="bg-gradient-to-r from-[#f67062] to-[#fc5296] w-full h-full rounded-full relative"
                                style="width: 65%"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <div
                            ...
                            <div class="flex items-center justify-between py-2">
                                <h6
                                    class="text-[#515365] font-semibold dark:text-white-dark">
                                    March<span
                                        class="block text-white-dark dark:text-white-light"
                                        >Pro Membership</span
                                    >
                                </h6>
                                <div
                    ...
                    <div>
                        <div
                            ...
                            <div class="flex items-center justify-between py-2">
                                ...
                                <div
                                    class="flex items-center justify-between flex-auto ltr:ml-4 rtl:mr-4">
                                    <h6
                                        class="text-[#515365] font-semibold dark:text-white-dark">
                                        American Express
                                        <span
                                            class="block text-white-dark dark:text-white-light"
                                            >Expires on 12/2025</span
                                        >
                                    </h6>
                                    <span
                                        class="badge bg-success ltr:ml-auto rtl:mr-auto"
                                        >Primary</span
                                    >
                                </div>
                            </div>
