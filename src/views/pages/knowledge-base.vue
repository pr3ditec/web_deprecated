<template>
    <div>
        ...
        <h3 class="mb-8 text-center text-xl font-semibold md:text-2xl">
            Some common <span class="text-primary">questions</span>
        </h3>
        ...
        <div
            ...
            <div class="flex-1 py-3.5 text-center md:text-start">
                ...
                <div class="text-lg font-medium text-white-dark">
                    Loaded with awesome features like documentation, knowledge
                    base forum, domain transfer, affiliates etc.
                </div>
        ...
        <div class="mt-10">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
                <div
                    ...
                    <div class="flex">
                        <div
                            class="me-4 overflow-hidden rounded-full bg-white-dark">
                            <img
                        ...
                        <div class="flex-1">
                            <h4 class="mb-1.5 font-semibold dark:text-white">
                                Alma Clark
                            </h4>
                            <p>06 May</p>
                        </div>
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
                <template v-for="(item, i) in items" :key="i">
                    <div
                        class="space-y-5 rounded-md border border-white-light bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#1B2E4B] dark:bg-black">
                        <div
                            class="relative h-[340px] overflow-hidden rounded-md group">
                            <img
                                :src="item.src"
                                alt="video tutorial"
                            ...
                            <div
                                class="absolute bottom-0 left-0 w-full bg-white/30 px-5 py-[22px] text-center text-xl text-white backdrop-blur-[5px]">
                                Excessive sugar is harmful
                            </div>
                        </div>
                    </div>
