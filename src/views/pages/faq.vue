<template>
    <div>
        <div
                ...
                <img
                    :src="
                        store.theme === 'dark' || store.isDarkMode
                            ? '/assets/images/faq/faq-dark.svg'
                            : '/assets/images/faq/faq-light.svg'
                    "
                    alt="faqs"
            ...
            <div class="relative">
                <div
                    class="flex flex-col items-center justify-center sm:-ms-32 sm:flex-row xl:-ms-60">
                    <div
                        class="mb-2 flex gap-1 text-end text-base leading-5 sm:flex-col xl:text-xl">
                        <span>It's free </span>
                        <span>For everyone</span>
                    </div>
                    <div
                        class="me-4 ms-2 hidden sm:block text-[#0E1726] dark:text-white rtl:rotate-y-180">
                        <svg
                            width="111"
                            height="22"
                            viewBox="0 0 116 22"
                    ...
                    <div
                        class="mb-2 text-center text-2xl font-bold dark:text-white md:text-5xl">
                        FAQs
                    </div>
                </div>
                ...
                <form action="" method="" class="mb-6">
                    <div class="relative mx-auto max-w-[580px]">
                        ...
                        <button
                            type="button"
                            class="btn btn-primary absolute top-1 shadow-none ltr:right-1 rtl:left-1">
                            Search
                        </button>
                    </div>
                </form>
                <div
                    ...
                    <div
                        class="whitespace-nowrap font-medium text-black dark:text-white">
                        Popular topics :
                    </div>
                    <div
                        class="flex items-center justify-center gap-2 sm:gap-5">
                        <a
                            href="javascript:;"
                            class="duration-300 hover:underline">
                            Sales</a
                        >
                        <a
                            href="javascript:;"
        ...
        <div
            class="mb-12 flex items-center rounded-b-md bg-[#DBE7FF] dark:bg-[#141F31]">
            <ul
                class="mx-auto flex items-center gap-5 overflow-auto whitespace-nowrap px-3 py-4.5 xl:gap-8">
                <li
        ...
        <h3 class="mb-8 text-center text-xl font-semibold md:text-2xl">
            Frequently asked <span class="text-primary">questions</span>
        </h3>
        <div class="mb-10 grid grid-cols-1 gap-10 md:grid-cols-2">
            <div class="rounded-md bg-white dark:bg-black">
                <div
                    class="border-b border-white-light p-6 text-[22px] font-bold dark:border-dark dark:text-white">
                    General topics?
                </div>
                <div
                    class="divide-y divide-white-light px-6 py-4.5 dark:divide-dark">
                    <div>
                        <div
                            ...
                            :class="{
                                'bg-primary-light dark:bg-[#1B2E4B] !text-primary':
                                    active1 === 1,
                            }"
                            @click="
                                active1 === 1 ? (active1 = null) : (active1 = 1)
                            ">
                        ...
                        <vue-collapsible :isOpen="active1 === 1">
                            <div
                                class="px-1 py-3 font-semibold text-white-dark">
                                <p>
                    ...
                    <div>
                        <div
                            ...
                            @click="
                                active1 === 2 ? (active1 = null) : (active1 = 2)
                            ">
                            <span>
                                Where can I subscribe to your newsletter?</span
                            >
                    ...
                    <div>
                        <div
                            ...
                            @click="
                                active1 === 3 ? (active1 = null) : (active1 = 3)
                            ">
                            <span>How to install VRISTO Admin</span>
                    ...
                    <div>
                        <div
                            ...
                            @click="
                                active1 === 5 ? (active1 = null) : (active1 = 5)
                            ">
                            <span>How to install VRISTO Admin</span>
                ...
                <div
                    ...
                    <div>
                        <div
                            ...
                            @click="
                                active2 === 1 ? (active2 = null) : (active2 = 1)
                            ">
                    ...
                    <div>
                        <div
                            ...
                            @click="
                                active2 === 2 ? (active2 = null) : (active2 = 2)
                            ">
                    ...
                    <div>
                        <div
                            ...
                            @click="
                                active2 === 3 ? (active2 = null) : (active2 = 3)
                            ">
                    ...
                    <div>
                        <div
                            ...
                            @click="
                                active2 === 5 ? (active2 = null) : (active2 = 5)
                            ">
        ...
        <div class="panel mt-10 text-center md:mt-20">
            <h3 class="mb-2 text-xl font-bold dark:text-white md:text-2xl">
                Still need help?
            </h3>
            <div class="text-lg font-medium text-white-dark">
                Our specialists are always happy to help. Contact us during
                standard business hours or email us24/7 and we'll get back to
                you.
            </div>
            <div
