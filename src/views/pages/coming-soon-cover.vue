    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <div class="relative hidden w-full items-center justify-center p-5 lg:inline-flex lg:max-w-[835px] ltr:xl:-ml-24 ltr:xl:skew-x-[14deg] rtl:xl:-mr-24 rtl:xl:skew-x-[-14deg]"
                ...
                <div class="relative w-full px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    <div class="mx-auto mt-5 w-full max-w-[550px] lg:mt-16">
                        ...
                        <div class="mb-12">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Coming Soon
                            </h1>
                            <p class="text-base font-bold leading-normal text-white-dark">We will be here in a
                                shortwhile.....</p>
                        </div>
                        <div
                        ...
                        <div class="mb-20 md:mb-32">
                            <h2 class="text-lg font-bold uppercase dark:text-white sm:text-xl">Subscribe to get notified!
                            </h2>
