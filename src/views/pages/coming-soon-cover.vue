        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    ">
                    <div
                        class="absolute inset-y-0 w-8 from-primary/10 via-transparent to-transparent ltr:-right-10 ltr:bg-gradient-to-r rtl:-left-10 rtl:bg-gradient-to-l xl:w-16 ltr:xl:-right-20 rtl:xl:-left-20"></div>
                    <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                        <router-link
                            to="/"
                            class="w-48 block lg:w-72 mx-auto 2xl:m-0">
                            <img
                        ...
                        <div
                            class="mt-24 hidden w-full max-w-[430px] rtl:rotate-y-180 lg:block">
                            <img
                ...
                <div
                    class="relative w-full px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    <div class="mx-auto mt-5 w-full max-w-[550px] lg:mt-16">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    class="absolute inset-1 flex flex-col gap-1">
                                    <span
                                        class="h-full w-full rounded-md bg-primary/[12%]"></span>
                                    <span
                                        class="h-full w-full rounded-md bg-white"></span>
                                </div>
                        ...
                        <div class="mb-20 md:mb-32">
                            <h2
                                class="text-lg font-bold uppercase dark:text-white sm:text-xl">
