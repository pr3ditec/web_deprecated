                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 md:mb-5">
                        ...
                        <div class="panel">
                            <div class="flex items-center font-semibold mb-5">
                                <div
                                    class="shrink-0 w-10 h-10 rounded-full grid place-content-center">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        xml:space="preserve"
                                        width="100%"
                                ...
                                <div class="ltr:ml-2 rtl:mr-2">
                                    <h6 class="text-dark dark:text-white-light">
                                        BTC
                                    </h6>
                            ...
                            <div
                                ...
                                $20,000
                                <span class="text-success font-normal text-sm"
                                    >+0.25%</span
                                >
                            </div>
                        </div>
                        ...
                        <div class="panel">
                            <div class="flex items-center font-semibold mb-5">
                                <div
                                    class="shrink-0 w-10 h-10 bg-warning rounded-full grid place-content-center p-2">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        xml:space="preserve"
                                        width="100%"
                            ...
                            <div
                                class="flex justify-between items-center font-bold text-base">
                                $21,000
                                <span class="text-danger font-normal text-sm"
                                    >-1.25%</span
                                >
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
                        ...
                        <div class="panel">
                            <div class="flex items-center font-semibold mb-5">
                                <div
                                    class="shrink-0 w-10 h-10 bg-warning rounded-full p-2 grid place-content-center">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="100%"
                ...
                <div class="grid gap-6 xl:grid-flow-row">
                    ...
                    <div class="panel overflow-hidden">
                        ...
                        <div class="relative mt-10">
                            <div
                                class="absolute -bottom-12 ltr:-right-12 rtl:-left-12 w-24 h-24">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                    ...
                    <div class="table-responsive">
                        <table>
                            <thead>
                                <tr>
                                    <th
                                        class="ltr:rounded-l-md rtl:rounded-r-md">
                                        ID
                                    </th>
                                    <th>DATE</th>
                                    <th>NAME</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="badge bg-success/20 text-success rounded-full hover:top-0"
                                            >Completed</span
                                        >
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="badge bg-info/20 text-info rounded-full hover:top-0"
                                            >In Process</span
                                        >
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="badge bg-danger/20 text-danger rounded-full hover:top-0"
                                            >Pending</span
                                        >
                                    </td>
                                </tr>
