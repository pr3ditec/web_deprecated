...
<template>
    ...
    >
        ...
        <TransitionGroup name="list" tag="div">
            ...
            <div
                v-else
                class="flex flex-row justify-content-center align-items-center gap-4 w-full"
            >
                <div class="flex flex-col">
                    ...
                    <input
                        type="text"
                        class="form-input"
                        placeholder="Ex.: Fernando Miguel"
                    />
                </div>
                <div class="flex flex-col">
                ...
                <button class="btn btn-success h-1/2 self-end capitalize">
                    Confirmar
                </button>
            </div>
        </TransitionGroup>
        ...
        <button
            ...
            @click="agendarPaciente = !agendarPaciente"
        >
            <svg
