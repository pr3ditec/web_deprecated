...
<template>
    <div>
        <div class="space-y-8">
            <div
                class="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary lg:col-span-2">
                <div
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <p class="mb-5">
                        Solar is a collection of simply beautiful open source
                        icons. Each icon is designed on a 24x24 grid with an
                        emphasis on simplicity, consistency and usability.
                    </p>
                    <div
                        class="bg-[#009688]/[.26] text-[#009688] py-1 px-2 rounded inline-block text-base mb-5">
                        Line Duotone
                    </div>
