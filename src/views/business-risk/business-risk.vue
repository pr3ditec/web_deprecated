            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center font-semibold mt-5">
                        {{ $t("averageInstallments") }} {{ mediaParcelamento }}
                    </div>
                </div>
            </div>
