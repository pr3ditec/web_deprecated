                    ...
                    <form class="space-y-5">
                        <div>
                            <input
                                ...
                                class="form-input" />
                            <span
                                class="text-white-dark text-[11px] inline-block mt-1"
                        ...
                        <div>
                            <label
                                class="inline-flex items-center mt-1 cursor-pointer">
                                <input type="checkbox" class="form-checkbox" />
                                <span class="text-white-dark"
                                    >Subscribe to weekly newsletter</span
                                >
                            </label>
                        </div>
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <form class="space-y-5">
                        ...
                        <div class="flex sm:flex-row flex-col">
                            <label class="sm:w-1/4 sm:ltr:mr-2 rtl:ml-2"
                                >Choose Segements</label
                            >
                            <div class="flex-1">
                                <div class="mb-2">
                                    <label
                                        class="inline-flex mt-1 cursor-pointer">
                                        <input
                                            type="radio"
                                            name="segements"
                                            class="form-radio" />
                        ...
                        <div class="flex sm:flex-row flex-col">
                            <label
                                class="font-semibold sm:w-1/4 sm:ltr:mr-2 rtl:ml-2"
                                >Apply</label
                            >
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <form class="space-y-5">
                        ...
                        <div class="!mt-2">
                            <span
                                class="text-white-dark text-[11px] inline-block"
...
&lt;/form&gt;
            ...
            <div class="panel lg:col-span-2">
                ...
                <div class="mb-5">
                    <form>
                        <div
                            class="flex flex-col md:flex-row gap-4 items-center max-w-[900px] mx-auto">
                            <input
                                type="email"
