    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            ...
            <div
                ...
                ><a
                    href="https://www.npmjs.com/package/vue3-form-wizard"
                    target="_blank"
                    ...
                    <div class="mb-5">
                        <form-wizard
                            ...
                            <tab-content title="2 About">
                                <p>
                                    The next and previous buttons help you to
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <form-wizard shape="tab" color="#4361ee" class="pills">
                            ...
                            <tab-content
                                custom-icon='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5"><circle cx="12" cy="6" r="4" stroke="currentColor" stroke-width="1.5"/><ellipse opacity="0.5" cx="12" cy="17" rx="7" ry="4" stroke="currentColor" stroke-width="1.5"/></svg>'>
                                <p>
                                    The next and previous buttons help you to
                                    navigate through your content.
                                </p>
