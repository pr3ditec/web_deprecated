    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div
                ...
                ><a
                    href="https://www.npmjs.com/package/maska"
                    target="_blank"
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <p class="text-white-dark mb-5">
                            Input mask are use with
                            <span class="text-danger">input</span> tags.
                        </p>
                        <form>
                            <fieldset
                                class="grid grid-cols-1 md:grid-cols-2 items-end gap-4">
                                <div>
                                    <label
                                        for="staticMask1"
...
&lt;/form&gt;
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <form>
                            <fieldset>
                                <label for="ipMask" class="text-white-dark"
                                    >v-maska="'###.###.###.###'"
                                    (192.198.1.1)</label
                                >
                                <input
...
&lt;/form&gt;
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <form>
                            <fieldset>
                                <label for="phoneMask" class="text-white-dark"
                                    >v-maska="'(###) ###-####'" ((999)
                                    999-9999)</label
                                >
                                <input
