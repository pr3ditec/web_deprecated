...
import FormPasswordReset from "@/components/layout/password-reset/FormPasswordReset.vue";
    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <div
                    class="flex w-full max-w-[440px] items-center justify-items-end gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
