                ...
                >
                    ...
                    >
                        <div class="w-8 block lg:hidden">
                            <img src="/assets/images/logos/plus.png" alt="Logo" class="mx-auto w-10" />
                        </div>
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="submitForm">
                            ...
                            <button
                                type="submit"
                                class="btn btn-gradient !mt-6 w-full border-2 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]"
