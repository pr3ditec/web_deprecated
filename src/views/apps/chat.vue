        ...
        <div
                    ...
                    <perfect-scrollbar
                        ...
                        <template
                            ...
                            <button
                                        ...
                                        <div class="flex-shrink-0 relative">
                                            ...
                                            <template v-if="person.active">
                                                <div
                                                    ...
                                                    <div
                                                        class="w-4 h-4 bg-success rounded-full"></div>
                                                </div>
                                            </template>
                                        </div>
                                        <div
                                ...
                                <div
                                    class="font-semibold whitespace-nowrap text-xs">
                                    <p>{{ person.time }}</p>
                                </div>
                            </button>
                        </template>
            ...
            <div class="panel p-0 flex-1">
                <template v-if="!isShowUserChat">
                    <div
                        class="flex items-center justify-center h-full relative p-4">
                        <button
                            type="button"
                        ...
                        <div
                            class="py-8 flex items-center justify-center flex-col">
                            <div
                ...
                <template v-if="isShowUserChat && selectedUser">
                    <div class="relative h-full">
                        ...
                        <div
                            class="h-px w-full border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                        <perfect-scrollbar
                            class="relative h-full sm:h-[calc(100vh_-_300px)] chat-conversation-box">
                            <div
                                class="space-y-5 p-4 sm:pb-0 pb-[68px] sm:min-h-[300px] min-h-[400px]">
                                <div class="block m-6 mt-0">
                                    <h4
                                        class="text-xs text-center border-b border-[#f4f4f4] dark:border-gray-800 relative">
                                        <span
                                            class="relative top-2 px-3 bg-white dark:bg-[#0e1726]"
                                            >{{
...
const sendMessage = () => {
    if (textMessage.value.trim()) {
        const user: any = contactList.value.find(
            (d) => d.userId === selectedUser.value.userId,
        );
        user.messages.push({
