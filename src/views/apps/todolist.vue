                    ...
                    <perfect-scrollbar :options="{
                        ...
                        <div class="space-y-1">
                            ...
                            <button type="button"
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45 fill-success shrink-0">
                                    <path
                            ...
                            <button type="button"
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45 fill-warning shrink-0">
                                    <path
                                        d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z"
                                        stroke="currentColor" stroke-width="1.5" />
                                </svg>
                    ...
                    <div class="ltr:left-0 rtl:right-0 absolute bottom-0 p-4 w-full">
                        <button class="btn btn-primary w-full" type="button" @click="addEditTask()">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="w-5 h-5 ltr:mr-2 rtl:ml-2 shrink-0">
                        ...
                        <div class="ltr:mr-3 rtl:ml-3 flex items-center">
                            ...
                            <div class="relative group flex-1">
                                <input type="text" class="form-input peer ltr:!pr-10 rtl:!pl-10"
                                    placeholder="Search Task..." v-model="searchTask" @keyup="searchTasks()" />
                                <div
                                        ...
                                        <tr class="group cursor-pointer"
                                            ...
                                            <td class="w-1">
                                                <input type="checkbox" :id="`chk-${task.id}`" class="form-checkbox"
                                                    :checked="task.status === 'complete'" @click.stop="taskComplete(task)"
                                                                    ...
                                                                    <ul @click="close()" class="text-sm text-medium">
                                                                        <li>
                                                                            <button type="button"
                                                                                ...
                                                                                @click="setTag(task, 'team')">
                                                                                Team
                                                                            </button>
                                                                        </li>
                                                                        <li>
                                                                            <button type="button" class="w-full text-info"
                                                                                @click="setTag(task, 'update')">
                                                                                Update
                                                                            </button>
                                                                        </li>
                                                                        <li>
                                                                            <button type="button" class="w-full"
                                                                                @click="setTag(task, '')">None</button>
                                                                        </li>
                                                                    </ul>
                                                                </template>
                                                            </Popper>
                                            ...
                                            <td class="w-1">
                                                <div class="flex items-center justify-between w-max">
                                                    <div class="ltr:mr-2.5 rtl:ml-2.5 flex-shrink-0">
                                                        ...
                                                        <div v-if="!task.path && task.assignee"
                                        ...
                                        <form @submit.prevent="saveTask">
                                            <div class="mb-5">
                                                ...
                                                <input id="title" type="text" placeholder="Enter Task Title"
                                                    class="form-input" v-model="params.title" />
                                            </div>
                                            <div class="mb-5">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <quillEditor ref="editor" v-model:value="params.description"
                                                    :options="editorOptions" style="min-height: 200px"
                                            ...
                                            <div class="ltr:text-right rtl:text-left flex justify-end items-center mt-8">
                                                ...
                                                <button type="submit" class="btn btn-primary ltr:ml-4 rtl:mr-4">{{ params.id
                                                    ? 'Update' : 'Add' }}</button>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                                ...
                                <DialogPanel
                                    ...
                                    <div
                                        ...
                                        <div v-show="selectedTask.priority" class="badge rounded-3xl capitalize" :class="{
                                        ...
                                        <div v-show="selectedTask.tag" class="badge rounded-3xl capitalize" :class="{
