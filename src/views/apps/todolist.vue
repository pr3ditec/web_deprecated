        ...
        <div class="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
            <div
                ...
                <div class="flex flex-col h-full pb-16">
                    ...
                    <div
                        class="h-px w-full border-b border-[#e0e6ed] dark:border-[#1b2e4b] mb-5"></div>
                    <perfect-scrollbar
                        :options="{
                            swipeEasing: true,
            ...
            <div
                ...
                @click="isShowTaskMenu = !isShowTaskMenu"></div>
            <div class="panel p-0 flex-1 overflow-auto h-full">
                <div class="flex flex-col h-full">
                    <div
                        class="p-4 flex sm:flex-row flex-col w-full sm:items-center gap-4">
                        ...
                        <div
                            class="flex items-center justify-center sm:justify-end sm:flex-auto flex-1">
                            ...
                            <button
                                ...
                                @click="
                                    pager.currentPage--, searchTasks(false)
                                ">
                                <svg
                                    width="24"
                                    height="24"
                                ...
                                <tbody>
                                    <template
                                        ...
                                        <tr
                                            ...
                                            <td class="w-1">
                                                <div
                                                    class="flex items-center justify-between w-max">
                                                    <div
                                                        class="ltr:mr-2.5 rtl:ml-2.5 flex-shrink-0">
                                                        <div v-if="task.path">
                                                            <img
                                        ...
                                        <form @submit.prevent="saveTask">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <select
                                                    ...
                                                    <option value="Kia Vega">
                                                        Kia Vega
                                                    </option>
                                                    <option value="Sandy Doe">
                                                        Sandy Doe
                                                    </option>
                                            ...
                                            <div
                                                class="mb-5 flex justify-between gap-4">
                                                <div class="flex-1">
                                            ...
                                            <div
                                                class="ltr:text-right rtl:text-left flex justify-end items-center mt-8">
                                                <button
                                                    type="button"
...
const searchTasks = (isResetPage = true) => {
    ...
    let res;
    if (
        selectedTab.value === "complete" ||
        selectedTab.value === "important" ||
        selectedTab.value === "trash"
    ) {
    ...
    if (selectedTab.value === "team" || selectedTab.value === "update") {
        ...
        selectedTab.value === "high" ||
        selectedTab.value === "medium" ||
        selectedTab.value === "low"
    ) {
        res = res.filter((d) => d.priority === selectedTab.value);
    }
    filteredTasks.value = res.filter(
        (d) => d.title?.toLowerCase().includes(searchTask.value),
    );
    getPager();
};
        ...
        if (filteredTasks.value.length) {
            pager.value.totalPages =
                pager.value.pageSize < 1
                    ? 1
                    : Math.ceil(
                          filteredTasks.value.length / pager.value.pageSize,
                      );
            ...
            pagedTasks.value = filteredTasks.value.slice(
                pager.value.startIndex,
...
const saveTask = () => {
    ...
    if (params.value.id) {
        ...
        //add task
        const maxid = allTasks.value.length
            ? allTasks.value.reduce(
