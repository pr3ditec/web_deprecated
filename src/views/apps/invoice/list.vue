    ...
    <div>
        <div class="panel px-0 pb-1.5 border-[#e0e6ed] dark:border-[#1b2e4b]">
            <div class="datatable invoice-table">
                ...
                <vue3-datatable ref="datatable" :rows="items" :columns="cols" :totalRows="items?.length" :hasCheckbox="true"
                    :sortable="true" :search="search" skin="whitespace-nowrap bh-table-hover"
                    ...
                    <template #invoice="data">
                        <router-link to="/apps/invoice/preview"
                            class="text-primary underline font-semibold hover:no-underline">#{{ data.value.invoice
                            }}</router-link>
                    </template>
                    <template #name="data">
                    ...
                    <template #status="data">
                        <span class="badge"
                            :class="[data.value.status.toLowerCase() === 'paid' ? 'badge-outline-success' : 'badge-outline-danger']">{{
                                data.value.status
                            }}</span>
                    </template>
