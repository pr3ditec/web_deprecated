            ...
            <div class="panel px-0 flex-1 py-6 ltr:xl:mr-6 rtl:xl:ml-6">
                <div class="flex justify-between flex-wrap px-4">
                    <div class="mb-6 lg:w-1/2 w-full">
                        <div
                            class="flex items-center text-black dark:text-white shrink-0">
                            <img
                        ...
                        <div
                            class="space-y-1 mt-6 text-gray-500 dark:text-gray-400">
                            <div>
                                13 Tetrick Road, Cypress Gardens, Florida,
                                33884, US
                            </div>
                    ...
                    <div class="lg:w-1/2 w-full lg:max-w-fit">
                        <div class="flex items-center">
                            <label
                                for="number"
                                class="flex-1 ltr:mr-2 rtl:ml-2 mb-0"
                        ...
                        <div class="lg:w-1/2 w-full">
                            ...
                            <div class="flex items-center mt-4">
                                ...
                                <select
                                    ...
                                    v-model="params.bankInfo.country">
                ...
                <div class="mt-8">
                    ...
                    <div
                        class="flex justify-between sm:flex-row flex-col mt-6 px-4">
                        ...
                        <div class="sm:w-2/5">
                            ...
                            <div
                                class="flex items-center justify-between mt-4 font-semibold">
                                <div>Total</div>
                                <div>$265.00</div>
                            </div>
                        </div>
...
onMounted(() => {
    ...
    items.value.push(
        ...
        },
        {
            ...
            description:
                "Customized Chat Application to resolve some Bug Fixes",
            quantity: 1,
            amount: 25,
            isTax: false,
        },
