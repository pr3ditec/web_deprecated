...
<template>
    <div>
        <div
            class="flex items-center lg:justify-end justify-center flex-wrap gap-4 mb-6">
        ...
        <div class="panel">
            ...
            <div
                class="flex justify-between lg:flex-row flex-col gap-6 flex-wrap">
                <div class="flex-1">
                ...
                <div
                    class="flex justify-between sm:flex-row flex-col gap-6 lg:w-2/3">
                    <div class="xl:1/3 lg:w-2/5 sm:w-1/2">
                        <div
                            class="flex items-center w-full justify-between mb-2">
