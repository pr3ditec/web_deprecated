                    ...
                    <perfect-scrollbar :options="{
                        ...
                        <div class="space-y-1">
                                            ...
                                            <button type="button"
                                                ...
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="currentColor" stroke-width="1.5" />
                                                    <path opacity="0.5" d="M15 6H9" stroke="currentColor" stroke-width="1.5"
                                                        stroke-linecap="round" />
                                                </svg>
                            ...
                            <button type="button"
                                ...
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 rotate-180 shrink-0">
                                        <path opacity="0.5"
                ...
                <div v-show="!selectedMail && !isEdit" class="flex flex-col h-full">
                    <div class="flex justify-between items-center flex-wrap-reverse gap-4 p-4">
                        <div class="flex items-center w-full sm:w-auto">
                            ...
                            <div class="ltr:mr-4 rtl:ml-4">
                                <button type="button" v-tippy:refresh class="hover:text-primary flex items-center"
                                    @click="refreshMails()">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <li>
                                        <div>
                                            <button type="button" v-tippy:archive
                                                class="hover:text-primary flex items-center" @click="setArchive">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
                                                    <path
                                                        d="M9 12C9 11.5341 9 11.3011 9.07612 11.1173C9.17761 10.8723 9.37229 10.6776 9.61732 10.5761C9.80109 10.5 10.0341 10.5 10.5 10.5H13.5C13.9659 10.5 14.1989 10.5 14.3827 10.5761C14.6277 10.6776 14.8224 10.8723 14.9239 11.1173C15 11.3011 15 11.5341 15 12C15 12.4659 15 12.6989 14.9239 12.8827C14.8224 13.1277 14.6277 13.3224 14.3827 13.4239C14.1989 13.5 13.9659 13.5 13.5 13.5H10.5C10.0341 13.5 9.80109 13.5 9.61732 13.4239C9.37229 13.3224 9.17761 13.1277 9.07612 12.8827C9 12.6989 9 12.4659 9 12Z"
                        ...
                        <div class="flex justify-between items-center sm:w-auto w-full">
                            <div class="flex items-center ltr:mr-4 rtl:ml-4">
                                ...
                                <div class="relative group">
                                    <input type="text" placeholder="Search Mail" class="form-input ltr:pr-8 rtl:pl-8 peer"
                                        ...
                                        <tr class="cursor-pointer" @click="selectMail(mail)">
                                            <td>
                                                <div class="flex items-center whitespace-nowrap">
                                                    ...
                                                    <div class="dark:text-gray-300 whitespace-nowrap font-semibold" :class="{
                    ...
                    <template v-if="!pagedMails.length">
                        <div class="grid place-content-center min-h-[300px] font-semibold text-lg h-full">No data available
                        </div>
                    </template>
                </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div v-show="selectedMail.group" class="ltr:mr-4 rtl:ml-4">
                                                <div v-tippy:group class="w-2 h-2 rounded-full" :class="{
                                            ...
                                            <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'"
                                                ...
                                                <template #content>
                                                    <ul class="sm:w-56">
                                                        ...
                                                        <li>
                                                            <div class="flex items-center px-4 py-2">
                                                                <div class="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4">To:
                                                                </div>
                                                                <div class="flex-1">
                                                                    {{ selectedMail.type !== 'sent_mail' ?
                                                                        'tailly@gmail.com' : selectedMail.email }}
                                                        ...
                                                        <li>
                                                            <div class="flex items-center px-4 py-2">
                                                                <div class="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4">
                                                                    Subject:</div>
                                ...
                                <div>
                                    <div class="flex items-center justify-center space-x-3 rtl:space-x-reverse">
                                        ...
                                        <button type="button" v-tippy:important
                                            ...
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5 rotate-90"
                                        ...
                                        <button type="button" v-tippy:reply class="hover:text-info"
                                            ...
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 rtl:hidden">
                                                <path d="M9.5 7L4.5 12L9.5 17" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path opacity="0.5" d="M4.5 12L14.5 12C16.1667 12 19.5 13 19.5 17"
                                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                            </svg>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:hidden rtl:block">
                                                <path d="M14.5 7L19.5 12L14.5 17" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
