                ...
                <div class="flex flex-col h-full pb-16">
                    ...
                    <perfect-scrollbar
                        ...
                        <div class="space-y-1">
                            <button
                                ...
                                <div
                                    class="bg-primary-light dark:bg-[#060818] rounded-md py-0.5 px-2 font-semibold whitespace-nowrap">
                                    {{
                                        mailList &&
                                        mailList.filter(
                                            (d) => d.type == "inbox",
                    ...
                    <div
                        ...
                        <button
                            ...
                            <div
                                class="bg-primary-light dark:bg-[#060818] rounded-md py-1 px-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
            ...
            <div class="panel p-0 flex-1 overflow-x-hidden h-full">
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center w-full sm:w-auto">
                            ...
                            <template v-if="selectedTab != 'trash'">
                                <ul
                                    class="flex grow items-center sm:flex-none gap-4 ltr:sm:mr-4 rtl:sm:ml-4">
                                    <li>
                                        <div>
                                            <button
                                                type="button"
                                                    ...
                                                    <ul @click="close()">
                                                        ...
                                                        <li>
                                                            <a
                                                                ...
                                                                ">
                                                                <div
                                                                    class="w-2 h-2 rounded-full bg-danger ltr:mr-3 rtl:ml-3 shrink-0"></div>
                                                                Private
                                                            </a>
                                                        </li>
                                                    </ul>
                            ...
                            <template v-if="selectedTab == 'trash'">
                                <ul
                                    class="flex flex-1 items-center sm:flex-none gap-4 ltr:sm:mr-3 rtl:sm:ml-4">
                                    <li>
                                        <div>
                                            <button
                                                type="button"
                    ...
                    <div
                        class="h-px border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                    <div
                        class="flex flex-wrap flex-col md:flex-row xl:w-auto justify-between items-center px-4 pb-4">
                        <div
                            class="w-full sm:w-auto grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
                            <button
                                type="button"
                        ...
                        <div class="mt-4 md:flex-auto flex-1">
                            <div
                                class="flex items-center md:justify-end justify-center">
                                ...
                                <button
                                    ...
                                    @click="
                                        pager.currentPage--, searchMails(false)
                                    ">
                                    <svg
                                        width="24"
                                        height="24"
                    ...
                    <template v-if="pagedMails.length">
                        <div
                            class="table-responsive grow overflow-y-auto min-h-[300px]">
                            <table>
                                <tbody>
                                    <template
                                        ...
                                        <tr
                                            ...
                                            <td
                                                class="whitespace-nowrap font-medium ltr:text-right rtl:text-left">
                                                {{ showTime(mail) }}
                                            </td>
                                        </tr>
                                    </template>
                    ...
                    <template v-if="!pagedMails.length">
                        <div
                            class="grid place-content-center min-h-[300px] font-semibold text-lg h-full">
                            No data available
                        </div>
                    </template>
                </div>
                <template v-if="selectedMail && !isEdit">
                    <div>
                        <div
                            class="flex items-center justify-between flex-wrap p-4">
                            <div class="flex items-center">
                                <button
                                    type="button"
                                    class="ltr:mr-2 rtl:ml-2 hover:text-primary"
                                ...
                                <h4
                                    class="text-base md:text-lg font-medium ltr:mr-2 rtl:ml-2">
                                    {{ selectedMail.title }}
                                </h4>
                                <div class="badge bg-info hover:top-0">
                                    {{ selectedMail.type }}
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="p-4 relative">
                            <div class="flex flex-wrap">
                                ...
                                <div class="ltr:mr-2 rtl:ml-2 flex-1">
                                    <div class="flex items-center">
                                        <div
                                            class="text-lg ltr:mr-4 rtl:ml-4 whitespace-nowrap">
                                            {{
                                                selectedMail.firstName
                                                    ? selectedMail.firstName +
                                                      " " +
                                                      selectedMail.lastName
                                                    : selectedMail.email
                                            }}
                                        </div>
                                        <div>
                                            <div
                                                v-show="selectedMail.group"
                                        ...
                                        <div
                                            class="text-white-dark whitespace-nowrap">
                                            1 days ago
                                        </div>
                                    </div>
                                    <div
                                        class="text-white-dark flex items-center">
                                                    ...
                                                    <ul class="sm:w-56">
                                                        <li>
                                                            <div
                                                                ...
                                                                <div
                                                                    class="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4">
                                                                    From:
                                                                </div>
                                                                <div
                                                                    class="flex-1">
                                ...
                                <div>
                                    <div
                                        ...
                                        <button
                                            ...
                                            :class="{
                                                'text-primary':
                                                    selectedMail.isImportant,
                                            }"
                                            @click="
                                                setImportant(selectedMail.id)
                                            "
                                            :disabled="selectedTab === 'trash'">
                                            <svg
                                                width="24"
                                ...
                                <div class="flex items-center flex-wrap mt-6">
                                    <template
                                        ...
                                        <button
                                            ...
                                            <div
                                                class="bg-dark-light/40 z-[5] w-full h-full absolute ltr:left-0 rtl:right-0 top-0 rounded-md hidden group-hover:block"></div>
                                            <div
                ...
                <template v-if="isEdit">
                    <div class="relative">
                        <div class="py-4 px-6 flex items-center">
                            ...
                            <h4
                                class="text-lg text-gray-600 dark:text-gray-400 font-medium">
                                Message
                            </h4>
                        </div>
                        <div
                        ...
                        <form class="p-6 grid gap-6">
                            ...
                            <div
                                class="flex items-center ltr:ml-auto rtl:mr-auto mt-8">
                                <button
                                    type="button"
                                    class="btn btn-outline-danger ltr:mr-3 rtl:ml-3"
                                    @click="closeMsgPopUp">
                                    Close
                                </button>
                                <button
                                    type="button"
                                    class="btn btn-success ltr:mr-3 rtl:ml-3"
                                    @click="saveMail('save', null)">
                                    Save
                                </button>
                                <button
                                    type="button"
                                    class="btn btn-primary"
                                    @click="saveMail('send', params.id)">
                                    Send
                                </button>
                            </div>
                        </form>
...
const checkAllCheckbox = computed(() => {
    if (
        filteredMailList.value.length &&
        ids.value.length === filteredMailList.value.length
    ) {
        return true;
    } else {
        return false;
...
const searchMails = (isResetPage = true) => {
    ...
    if (selectedTab.value === "important") {
        ...
        selectedTab.value === "work" ||
        selectedTab.value === "social" ||
        selectedTab.value === "private"
    ) {
    ...
    filteredMailList.value = res.filter(
        (d) =>
            ...
            (d.firstName &&
                d.firstName.toLowerCase().includes(searchText.value)) ||
            (d.lastName &&
                d.lastName.toLowerCase().includes(searchText.value)) ||
            (d.displayDescription &&
                d.displayDescription.toLowerCase().includes(searchText.value)),
    );
    if (filteredMailList.value.length) {
        pager.value.totalPages =
            pager.value.pageSize < 1
                ? 1
                : Math.ceil(
                      filteredMailList.value.length / pager.value.pageSize,
                  );
        if (pager.value.currentPage > pager.value.totalPages) {
            pager.value.currentPage = 1;
        }
        pager.value.startIndex =
            (pager.value.currentPage - 1) * pager.value.pageSize;
        pager.value.endIndex = Math.min(
            pager.value.startIndex + pager.value.pageSize - 1,
            filteredMailList.value.length - 1,
        );
        pagedMails.value = filteredMailList.value.slice(
            pager.value.startIndex,
...
const setSpam = () => {
    if (ids.value.length) {
        let items = filteredMailList.value.filter((d: any) =>
            ids.value.includes(d.id),
        );
...
const setArchive = () => {
    if (ids.value.length) {
        ...
        if (selectedTab.value == "archive") {
            showMessage(
                ids.value.length + " Mail has been removed from Archive.",
            );
        } else {
    ...
    if (ids.value.length) {
        ...
        for (let item of items) {
            if (type === "trash") {
                ...
                showMessage(
                    totalSelected + " Mail has been marked as Important.",
                );
            ...
            //restore & permanent delete
                ...
                mailList.value = mailList.value.filter(
                    (d: any) => d.id != item.id,
                );
...
const saveMail = (type: any, id: any) => {
    ...
    let maxId = 0;
    if (!params.value.id) {
        maxId = mailList.value.length
            ? mailList.value.reduce(
    ...
    let obj: any = {
        ...
        date:
            cDt.getMonth() + 1 + "/" + cDt.getDate() + "/" + cDt.getFullYear(),
