        ...
        <div class="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
            ...
            <div
                ...
                <div class="flex flex-col h-full pb-16">
                    ...
                    <div
                        class="h-px w-full border-b border-[#e0e6ed] dark:border-[#1b2e4b] my-4"></div>
                    <perfect-scrollbar
                        :options="{
                            swipeEasing: true,
                ...
                <template v-if="filterdNotesList.length">
                    <div class="sm:min-h-[300px] min-h-[400px]">
                        <div
                            ...
                            <template
                                v-for="note in filterdNotesList"
                                :key="note.id">
                                <div
                                    class="panel pb-12"
                                    :class="{
                                            ...
                                            <form @submit.prevent="saveNote">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <select
                                                        ...
                                                        <option
                                                            value="Karena Courtliff">
                                                            Karena Courtliff
                                                        </option>
                                                        <option
                                                            value="Vladamir Koschek">
                                                            Vladamir Koschek
                                                        </option>
                                                        <option
                                                            value="Robert Garcia">
...
const searchNotes = () => {
    if (selectedTab.value != "fav") {
        if (selectedTab.value != "all" || selectedTab.value === "delete") {
            filterdNotesList.value = notesList.value.filter(
                (d) => d.tag === selectedTab.value,
            );
        } else {
