                ...
                <div class="flex gap-3">
                    ...
                    <div>
                        <button
                            ...
                            :class="{
                                'bg-primary text-white': displayType === 'list',
                            }"
                    ...
                    <div>
                        <button
                            ...
                            class="btn btn-outline-primary p-2"
                            :class="{
                                'bg-primary text-white': displayType === 'grid',
                            }"
            ...
            <template v-if="displayType === 'list'">
                <div class="table-responsive">
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                            <template
                                v-for="contact in filterdContactsList"
                                :key="contact.id">
                                <tr>
                                    <td>
...
const searchContacts = () => {
    filterdContactsList.value = contactList.value.filter((d) =>
...
const saveUser = () => {
    ...
    if (params.value.id) {
        ...
        let maxUserId = contactList.value.length
            ? contactList.value.reduce(
                  (max, character) => (character.id > max ? character.id : max),
                  contactList.value[0].id,
              )
            : 0;
