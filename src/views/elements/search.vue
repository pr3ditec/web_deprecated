            ...
            <div class="panel lg:row-span-2">
                ...
                <div class="mb-5 space-y-5">
                    <div>
                        ...
                        <div
                            class="p-4 border border-white-dark/20 rounded-lg space-y-4 overflow-x-auto w-full block">
                            <template
                                ...
                                <div
                                    ...
                                    <div>{{ item.email }}</div>
                                    <div
                                        class="badge border-2 border-dashed"
                    ...
                    <form>
                        <div
                            ...
                            <button
                                ...
                                :class="{
                                    'ltr:!right-auto ltr:left-1 rtl:right-1':
                                        focus,
                                }">
                                <svg
                                    class="mx-auto"
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5 space-y-5">
                    <form>
                        <div
                            class="relative border border-white-dark/20 w-full flex">
                            <button
                                type="submit"
