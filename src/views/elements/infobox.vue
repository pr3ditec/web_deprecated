                ...
                <div class="mb-5">
                    <div class="flex flex-wrap w-full justify-center">
                        <div
                            ...
                            <h5
                                class="text-lg font-semibold mb-3.5 dark:text-white-light">
                                Layout Package
                            </h5>
                            ...
                            <a
                                href="javascript:;"
                                class="text-primary font-semibold hover:underline group"
                                >Discover
                                <svg
                                    width="24"
                                    height="24"
                ...
                <div class="mb-5">
                    <div class="flex flex-wrap w-full justify-center">
                        <div
                            ...
                            <h5
                                class="text-lg font-semibold mb-3.5 text-white-light">
                                Layout Package
                            </h5>
                            <p class="text-white-light text-[15px] mb-3.5">
                                Lorem ipsum dolor sit amet, labore et dolore
                                magna aliqua.
                            </p>
                            <a
                                href="javascript:;"
                                class="text-info font-semibold hover:underline group"
                                >Discover
                                <svg
                                    width="24"
                                    height="24"
                ...
                <div class="mb-5">
                    <div class="flex flex-wrap w-full justify-center">
                        <div
                            ...
                            <h5
                                class="text-dark text-lg font-semibold mb-3.5 dark:text-white-light">
                                Layout Package
                            </h5>
                            <p class="text-white-dark text-[15px] mb-3.5">
                                Lorem ipsum dolor sit amet, labore et dolore
