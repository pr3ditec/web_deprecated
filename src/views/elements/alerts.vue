                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    <div
                        ...
                        <span class="ltr:pr-2 rtl:pl-2"
                            ><strong class="ltr:mr-1 rtl:ml-1">Primary!</strong
                    ...
                    <div
                        ...
                        <span class="ltr:pr-2 rtl:pl-2"
                            ><strong class="ltr:mr-1 rtl:ml-1">Success!</strong
                            >Lorem Ipsum is simply dummy text of the
                            printing.</span
                        >
                        <button
                    ...
                    <div
                        ...
                        <span class="ltr:pr-2 rtl:pl-2"
                            ><strong class="ltr:mr-1 rtl:ml-1">Danger!</strong
                            >Lorem Ipsum is simply dummy text of the
                            printing.</span
                        >
                        <button
                    ...
                    <div
                        class="flex items-center p-3.5 rounded text-info bg-info-light dark:bg-info-dark-light">
                        <span class="ltr:pr-2 rtl:pl-2"
                            ><strong class="ltr:mr-1 rtl:ml-1">Info!</strong
                            >Lorem Ipsum is simply dummy text of the
                            printing.</span
                        >
                        <button
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    <div
                        class="flex items-center p-3.5 rounded text-white-dark border border-primary">
                        <span class="ltr:pr-2 rtl:pl-2">
                            <strong class="ltr:mr-2 rtl:ml-2">Primary!</strong
                    ...
                    <div
                        class="flex items-center border p-3.5 rounded text-white-dark border-danger">
                        <span class="ltr:pr-2 rtl:pl-2">
                            <strong class="ltr:mr-2 rtl:ml-2">Danger!</strong
                            >Lorem Ipsum is simply dummy text of the printing.
                        </span>
                        <button
                            type="button"
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    <div
                        class="flex items-center p-3.5 rounded text-white bg-primary">
                        <span class="ltr:pr-2 rtl:pl-2">
                            <strong class="ltr:mr-1 rtl:ml-1">Warning!</strong
                            >Lorem Ipsum is simply dummy text of the printing.
                        </span>
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    <div
                        ...
                        <span
                            class="absolute ltr:-left-11 rtl:-right-11 inset-y-0 text-white w-6 h-6 m-auto">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                    ...
                    <div
                        ...
                        <span
                            class="absolute ltr:-right-11 rtl:-left-11 inset-y-0 text-white w-6 h-6 m-auto">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                    <div
                        class="flex items-center p-3.5 rounded text-white bg-info">
                        ...
                        <button
                            type="button"
                            class="btn btn-sm bg-white text-black ltr:ml-auto rtl:mr-auto">
                            Accept
                        </button>
