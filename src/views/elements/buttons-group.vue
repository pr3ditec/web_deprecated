            ...
            <div class="panel">
                ...
                <div class="mb-5 text-center">
                    <div class="relative inline-flex align-middle">
                        ...
                        <button type="button" class="btn btn-dark rounded-none">
                            Middle
                        </button>
                        <button
                            type="button"
                            class="btn btn-dark ltr:rounded-l-none rtl:rounded-r-none">
                            Right
                        </button>
                    </div>
                </div>
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div
                        class="flex flex-wrap justify-center sm:justify-between items-center gap-4 w-full">
                        <div>
                            <div class="relative inline-flex align-middle">
                                <button
                                    type="button"
                        ...
                        <div class="flex relative items-stretch flex-wrap">
                            <div class="ltr:-mr-px rtl:-ml-px flex">
                                <span
                                    class="border border-[#e0e6ed] dark:border-[#17263c] ltr:rounded-l rtl:rounded-r bg-[#f1f2f3] flex items-center justify-center text-black px-4 py-1.5 dark:bg-[#1a1c2d] dark:text-white-dark"
                                    >@</span
                                >
                            </div>
                            <input
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5 text-center">
                    <div
                        class="relative inline-flex align-middle flex-col items-start justify-center">
                        <button
                            type="button"
                            class="btn btn-dark rounded-b-none w-full">
                            Button
                        </button>
                        <div class="dropdown">
                            <Popper
                        ...
                        <button
                            type="button"
                            class="btn btn-dark rounded-none w-full">
                            Button
                        </button>
                        <button
                            type="button"
                        ...
                        <div class="dropdown">
                            <Popper
                                ...
                                <a
                                    href="javascript:;"
                                    class="btn dropdown-toggle btn-dark rounded-t-none">
                                    Dropdown
                                    <svg
                                        width="24"
                                        height="24"
