    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div
                ...
                ><a
                    href="https://www.npmjs.com/package/tippy.vue"
                    target="_blank"
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex justify-center w-full gap-4">
                            ...
                            >
                            <tippy target="anchor"
                                >Popover using ANCHOR tag</tippy
                            >
                            ...
                            <tippy target="button"
                                >Popover using BUTTON tag</tippy
                            >
                        </div>
                    </div>
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            ...
                            <tippy target="bottom" placement="bottom"
                                >Popover on bottom</tippy
                            >
                            ...
                            <tippy
                                target="right"
                                :placement="
                                    store.rtlClass === 'rtl' ? 'left' : 'right'
                                "
                                >Popover on right</tippy
                            >
                        </div>
                    </div>
                ...
                <div class="panel lg:row-start-1 lg:col-start-2">
                    ...
                    <div class="mb-5">
                        <div class="flex justify-center gap-4 w-full">
                            ...
                            <tippy target="html"
                                ><strong>Bolded content</strong></tippy
                            >
                        </div>
                    </div>
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            ...
                            <tippy target="click" trigger="click"
                                >On click</tippy
                            >
                            <button
                                v-tippy:focus
                            ...
                            <tippy target="focus" trigger="focus"
                                >On focus</tippy
                            >
                            <button
                                v-tippy:delay
                            ...
                            <tippy target="noanimation" animation="false"
                                >Disable Animation</tippy
                            >
                        </div>
                    </div>
                ...
                <div class="panel lg:col-span-2">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            ...
                            <tippy target="info" :extra="{ theme: 'info' }"
                                >Info</tippy
                            >
                            ...
                            <tippy target="danger" :extra="{ theme: 'danger' }"
                                >Danger</tippy
                            >
                            ...
                            <tippy target="dark" :extra="{ theme: 'dark' }"
                                >Dark</tippy
                            >
                        </div>
                    </div>
