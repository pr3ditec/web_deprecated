                ...
                <div class="mb-5">
                    <ul class="font-semibold">
                        <li class="py-[5px]">
                            <button
                                ...
                                <svg
                                    ...
                                    :class="{
                                        'rotate-180': treeview1.includes('css'),
                                    }">
                                    <path
                                        d="M19 9L12 15L5 9"
                                        stroke="currentColor"
                        ...
                        <li class="py-[5px]">
                            ...
                            <vue-collapsible
                                :isOpen="treeview1.includes('images')">
                                <ul class="ltr:pl-14 rtl:pr-14">
                                    <li class="py-[5px]">
                                        <svg
                                            width="24"
                        ...
                        <li class="py-[5px]">
                            ...
                            <vue-collapsible
                                :isOpen="treeview1.includes('html')">
                                <ul class="ltr:pl-14 rtl:pr-14">
                                    <li class="py-[5px]">
                                        <button
                                            type="button"
                                            @click="toggleTreeview1('pages')">
                                            <svg
                                                width="24"
                                                height="24"
                                                viewBox="0 0 24 24"
                ...
                <div class="mb-5">
                    <ul class="font-semibold no-animtion">
                        <li>
                            <button
                                type="button"
                                @click="toggleTreeview2('parent-node')">
                                <svg
                            ...
                            <vue-collapsible
                                :isOpen="treeview2.includes('parent-node')">
                                <ul>
                                    <li class="py-[5px] ltr:pl-7 rtl:pr-7">
                                        <button
                                            type="button"
                                            @click="toggleTreeview2('img')">
                                            <svg
                                    ...
                                    <li class="py-[5px] ltr:pl-7 rtl:pr-7">
                                        ...
                                        <vue-collapsible
                                            :isOpen="treeview2.includes('css')">
                                            <ul>
                                                <li
                                                    class="py-[5px] ltr:pl-7 rtl:pr-7 text-secondary">
                                                    style.css
                                                </li>
                                            </ul>
                                        </vue-collapsible>
