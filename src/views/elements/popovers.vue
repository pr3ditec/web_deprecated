                    ...
                    <div class="mb-5">
                        <div class="flex justify-center w-full gap-4">
                            <a
                                ...
                                >Link</a
                            >
                            <tippy target="anchor" trigger="click"
                            ...
                            <tippy target="button" trigger="click"
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            ...
                            <tippy target="top" trigger="click" placement="top"
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            ...
                            <tippy target="hover" trigger="mouseenter"
                                >On hover</tippy
                            >
                            ...
                            <tippy target="delay" delay="1000" trigger="click"
                                >Delay 1s</tippy
                            >
