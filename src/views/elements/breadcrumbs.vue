...
&lt;/ol&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <ol
                        class="flex text-primary font-semibold dark:text-white-dark">
                        <li
                            class="bg-[#ebedf2] ltr:rounded-l-md rtl:rounded-r-md dark:bg-[#1b2e4b]">
                            <a
                                href="javascript:;"
...
&lt;/ol&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <ol
                        class="flex items-center flex-wrap text-gray-500 font-semibold dark:text-white-dark gap-y-4">
                        <li>
                            <a
                                href="javascript:;"
