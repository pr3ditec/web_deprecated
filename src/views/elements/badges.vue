            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex w-full">
                        ...
                        <div class="flex items-center justify-center w-1/2">
                            <span
                                class="badge badge-outline-primary rounded-full"
                                >Primary</span
                            >
                        </div>
                    </div>
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex w-full">
                        <div class="flex items-center justify-center w-1/2">
                            <span class="badge bg-primary rounded-none"
                                >Primary</span
                            >
                        </div>
                        <div class="flex items-center justify-center w-1/2">
                            <span
                                class="badge badge-outline-primary rounded-none"
                                >Primary</span
                            >
                        </div>
                    </div>
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5 dark:text-white-dark">
                    ...
                    <div
                        class="space-y-2 prose dark:prose-headings:text-white-dark">
                        <h1>
                            Example heading
                            <span class="badge bg-primary">Primary</span>
                        </h1>
                ...
                <div class="mb-5">
                    <div
                        ...
                        <button type="button" class="btn btn-primary my-4">
                            ...
                            >
                            <span
                                class="badge absolute ltr:right-0 rtl:left-0 -top-3 bg-danger p-0.5 px-1.5 rounded-full"
                                >9</span
                            >
                        </button>
                        ...
                        <button
                            type="button"
                            class="btn btn-secondary px-5 my-4">
                            <span>
                                <svg
                                    width="24"
                                    height="24"
                        ...
                        <div
                            class="flex flex-wrap items-center justify-center gap-3">
                            <span
                                class="badge bg-warning p-0 ltr:pr-4 rtl:pl-4 my-4 rounded-full flex items-center text-base">
                                <img
                            ...
                            >
                            <span
                                class="badge bg-danger p-0 ltr:pr-4 rtl:pl-4 my-4 rounded-full flex items-center text-base">
                                <img
                                    src="/assets/images/profile-34.jpeg"
                                    alt=""
                                    class="w-10 h-10 rounded-full object-cover" /><span
                                ...
                                >
                                <span
                                    class="ltr:ml-4 rtl:mr-4 cursor-pointer hover:opacity-90"
                                    >x</span
                                ></span
                            >
                        </div>
