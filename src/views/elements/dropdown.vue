    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div
                ...
                <a
                    href="https://www.npmjs.com/package/vue3-popper"
                    target="_blank"
                        ...
                        <div class="flex flex-wrap w-full justify-around gap-7">
                            <div class="dropdown">
                                <Popper
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-info dropdown-toggle inline-flex">
                                        Up
                                        <svg
                                            width="24"
                                            height="24"
                            ...
                            <div class="dropdown">
                                <Popper
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-outline-info dropdown-toggle inline-flex">
                                        Up
                                        <svg
                                            width="24"
                                            height="24"
                        ...
                        <div class="flex flex-wrap w-full justify-around gap-7">
                            <div class="dropdown">
                                <Popper
                                    ...
                                    <template #content="{ close }">
                                        <ul
                                            class="whitespace-nowrap !my-0 ltr:ml-1 rtl:mr-1"
                                            @click="close()">
                                            <li>
                                                <a href="javascript:;"
                                                    >Action</a
                            ...
                            <div class="dropdown">
                                <Popper
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn btn-outline-warning dropdown-toggle">
                                        Right
                                        <svg
                                            width="24"
                                            height="24"
                        ...
                        <div class="flex flex-wrap w-full justify-around gap-7">
                            <div class="dropdown">
                                <Popper
                                    ...
                                    <template #content="{ close }">
                                        <ul
                                            class="whitespace-nowrap !my-0 ltr:mr-1 rtl:ml-1"
                                            @click="close()">
                                            <li>
                                                <a href="javascript:;"
                                                    >Action</a
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap w-full justify-around gap-7">
                            <div class="relative inline-flex align-middle">
                                <button
                                    type="button"
                                    class="btn btn-secondary ltr:rounded-r-none rtl:rounded-l-none">
                                    1
                                </button>
                                <button
                                    type="button"
                            ...
                            <div class="relative inline-flex align-middle">
                                <button
                                    type="button"
                                    class="btn btn-outline-secondary ltr:border-r-0 rtl:border-l-0 ltr:rounded-r-none rtl:rounded-l-none">
                                    1
                                </button>
                                <button
                                    type="button"
                                    class="btn btn-outline-secondary ltr:border-r-0 rtl:border-l-0 rounded-none">
                                    2
                                </button>
                                <div class="dropdown">
                                    <Popper
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap w-full justify-around gap-7">
                            ...
                            <div class="dropdown inline-flex">
                                <button
                                    type="button"
                                    class="btn btn-outline-primary ltr:rounded-r-none rtl:rounded-l-none">
                                    Action
                                </button>
                                <Popper
                                    :placement="
                                ...
                                <Popper
                                    ...
                                    <button
                                        ...
                                        <svg
                                            ...
                                            fill="none"
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="w-6 h-6 rotate-90 opacity-70">
                                            <circle
                                                cx="5"
                                                cy="12"
                                                r="2"
