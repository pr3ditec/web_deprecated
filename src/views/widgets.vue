    ...
    <div>
        <div class="grid xl:grid-cols-3 gap-6 mb-6">
            <div class="panel h-full xl:col-span-2">
                ...
                <p class="text-lg dark:text-white-light/90">
                    Total Profit <span class="text-primary ml-2">$10,840</span>
                </p>
                <div class="relative">
                    <apexchart
                        height="325"
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
            ...
            <div class="panel h-full">
                ...
                <div class="space-y-9">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            <div
                                class="flex font-semibold text-white-dark mb-2">
                                <h6>Income</h6>
            ...
            <div class="panel h-full p-0">
                <div
                    class="flex items-center justify-between w-full p-5 absolute">
                    <div class="relative">
                        <div
                    ...
                    <h5
                        class="font-semibold text-2xl ltr:text-right rtl:text-left dark:text-white-light">
                        3,192
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
                ...
                <perfect-scrollbar
                    ...
                    <div class="text-sm cursor-pointer">
                        <div class="flex items-center py-1.5 relative group">
                            <div
                                class="bg-primary w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                            <div class="flex-1">Updated Server Logs</div>
                            <div
                                class="ltr:ml-auto rtl:mr-auto text-xs text-white-dark dark:text-gray-500">
                                Just Now
                            </div>
                        ...
                        <div class="flex items-center py-1.5 relative group">
                            <div
                                class="bg-success w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                        ...
                        <div class="flex items-center py-1.5 relative group">
                            <div
                                class="bg-danger w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                        ...
                        <div class="flex items-center py-1.5 relative group">
                            <div
                                class="bg-black w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                            <div class="flex-1">
                        ...
                        <div class="flex items-center py-1.5 relative group">
                            <div
                                class="bg-warning w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                            <div class="flex-1">
                        ...
                        <div class="flex items-center py-1.5 relative group">
                            <div
                                class="bg-info w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                        ...
                        <div class="flex items-center py-1.5 relative group">
                            <div
                                class="bg-secondary w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                            <div class="flex-1">
                    ...
                    <div class="space-y-6">
                        <div class="flex">
                            ...
                            <div class="px-3 flex-1">
                                <div>Shaun Park</div>
                                <div
                                    class="text-xs text-white-dark dark:text-gray-500">
                                    10 Jan 1:00PM
                                </div>
                            </div>
                            <span
                                class="text-success text-base px-1 ltr:ml-auto rtl:mr-auto whitespace-pre"
                                >+$36.11</span
                            >
                        </div>
                        <div class="flex">
                            ...
                            <span
                                class="text-danger text-base px-1 ltr:ml-auto rtl:mr-auto whitespace-pre"
                                >-$16.44</span
                            >
                        </div>
                        <div class="flex">
            ...
            <div class="panel h-full p-0 border-0 overflow-hidden">
                <div
                    class="p-6 bg-gradient-to-r from-[#4361ee] to-[#160f6b] min-h-[190px]">
                ...
                <div class="-mt-12 px-8 grid grid-cols-2 gap-2">
                    <div
                        class="bg-white rounded-md shadow px-4 py-2.5 dark:bg-[#060818]">
                        <span
                            class="flex justify-between items-center mb-4 dark:text-white"
                            >Received
                            <svg
                ...
                <div class="p-5">
                    ...
                    <div class="mb-5 space-y-1">
                        <div class="flex items-center justify-between">
                            ...
                            <p class="text-base">
                                <span>$</span>
                                <span class="font-semibold">13.85</span>
                            </p>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="text-[#515365] font-semibold">
                                BlueHost VPN
                            </p>
                            <p class="text-base">
                                <span>$</span>
                                <span class="font-semibold">15.66</span>
                            </p>
                        </div>
                    </div>
                    <div class="text-center px-2 flex justify-around">
                        <button
                            type="button"
                            class="btn btn-secondary ltr:mr-2 rtl:ml-2">
                            View Details
                        </button>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr
                                ...
                                <td
                                    class="min-w-[150px] text-black dark:text-white">
                                    <div class="flex items-center">
                                        <img
                                ...
                                <td>
                                    <span
                                        class="badge bg-success shadow-md dark:group-hover:bg-transparent"
                                        >Paid</span
                                    >
                                </td>
                            </tr>
                            <tr
                                ...
                                <td>
                                    <span
                                        class="badge bg-secondary shadow-md dark:group-hover:bg-transparent"
                                        >Shipped</span
                                    >
                                </td>
                            </tr>
                            ...
                            <tr
                                ...
                                <td
                                    ...
                                    <div class="flex">
                                        ...
                                        <p class="whitespace-nowrap">
                                            Headphone
                                            <span
                                                class="text-primary block text-xs"
                                                >Digital</span
                                            >
                                        </p>
                                    </div>
                                ...
                                <td>
                                    <a
                                        ...
                                        href="javascript:;">
                                        <svg
                                            class="w-3.5 h-3.5 rtl:rotate-180 ltr:mr-1 rtl:ml-1"
                                            viewBox="0 0 24 24"
                                            fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <td class="text-black dark:text-white">
                                    <div class="flex">
                                        ...
                                        <p class="whitespace-nowrap">
                                            Watch
                                            <span
                                                class="text-danger block text-xs"
                                                >Accessories</span
                                            >
                                        </p>
                                    </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="panel h-full">
                ...
                <div class="text-[#e95f2b] text-3xl font-bold my-10">
                    ...
                    <svg
                        class="w-5 h-5 text-success inline"
                        viewBox="0 0 24 24"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="ltr:ml-5 rtl:mr-5 dark:text-white-light"
                        >57%</span
                    >
                </div>
            </div>
        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            <div class="panel h-full">
                <div
                    class="flex items-start border-b border-[#e0e6ed] dark:border-[#1b2e4b] -m-5 mb-5 p-5">
                    <div
                ...
                <div>
                    ...
                    <div
                        class="w-full absolute bottom-0 flex items-center justify-between p-5 -mx-5">
                        <div class="flex items-center">
                            <svg
                                width="24"
                                height="24"
            ...
            <div class="panel h-full">
                ...
                <div class="font-semibold text-center pb-8">
                    ...
                    <div
                        ...
                        <a
                            href="javascript:;"
                            class="btn btn-secondary btn-lg w-full border-0 bg-gradient-to-r from-[#3d38e1] to-[#1e9afe]"
                            >View Details</a
                        >
                    </div>
                </div>
                ...
                <div class="group">
                    <div class="mb-5">
                        <div class="text-white-dark">
                            Doloribus nisi vel suscipit modi, optio ex
                            repudiandae voluptatibus officiis commodi. Nesciunt
                            quas aut neque incidunt!
                        </div>
                    </div>
                    <div
                    ...
                    <div
                        ...
                        <div
                            class="bg-gradient-to-r from-[#1e9afe] to-[#60dfcd] h-full rounded-full"
                            style="width: 65%"></div>
                    </div>
                    <div class="flex items-end justify-between">
                        <div
                            ...
                            <svg
                                ...
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                class="w-3 h-3 ltr:mr-1 rtl:ml-1">
                                <circle
                                    opacity="0.5"
                                    cx="12"
                                    cy="12"
