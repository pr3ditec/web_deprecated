                    ...
                    <perfect-scrollbar
                        ...
                        <div class="space-y-7">
                            <div class="flex">
                                ...
                                <div>
                                    <h5
                                        class="font-semibold dark:text-white-light">
                                        New project created :
                                        <a
                                            href="javascript:;"
                                            class="text-success"
            ...
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div class="panel h-full">
                    ...
                    <div class="font-semibold text-center pb-8">
                        ...
                        <div
                            class="flex items-center justify-center gap-3 pb-8">
                            <img
                    ...
                    <div class="group">
                        <div class="mb-5">
                            <div class="text-white-dark">
                                ...
                                repudiandae voluptatibus officiis commodi.
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ltr:ml-2 rtl:mr-2 text-xs">
                                    5 Tasks
                                </div>
                            </div>
