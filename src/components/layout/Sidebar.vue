        ...
        <nav
            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group w-full" :class="{ active: activeDropdown === 'dashboard' }"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group w-full" :class="{ active: activeDropdown === 'Schedule' }"
                        @click="activeDropdown === 'Schedule' ? (activeDropdown = null) : (activeDropdown = 'Schedule')">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group w-full" :class="{ active: activeDropdown === 'register' }"
                        @click="activeDropdown === 'register' ? (activeDropdown = null) : (activeDropdown = 'register')">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'register' }">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                ...
                <li class="menu nav-item">
                    ...
                    <vue-collapsible :isOpen="activeDropdown === 'authentication'">
                        <ul class="sub-menu text-gray-500">
                            ...
                            <li @click="toggleMobileMenu">
                                <router-link to="/auth/password-reset" target="_blank">{{
                            ...
                            <ul>
                                ...
                                <li class="menu nav-item">
                                    ...
                                    <vue-collapsible :isOpen="activeDropdown === 'invoice'">
                                        <ul class="sub-menu text-gray-500">
                                            <li>
                                                <router-link to="/apps/invoice/list" @click="toggleMobileMenu">{{ $t('list')
                                                }}</router-link>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <router-link to="/apps/invoice/add" @click="toggleMobileMenu">{{ $t('add')
                                                }}</router-link>
                                            </li>
                                            <li>
                                                <router-link to="/apps/invoice/edit" @click="toggleMobileMenu">{{ $t('edit')
                                                }}</router-link>
                                            </li>
                                        </ul>
                                    </vue-collapsible>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'components'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li>
                                        <router-link to="/components/carousel" @click="toggleMobileMenu">{{ $t('carousel')
                                        }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/components/countdown" @click="toggleMobileMenu">{{ $t('countdown')
                                        }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/components/timeline" @click="toggleMobileMenu">{{ $t('timeline')
                                        }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/components/lightbox" @click="toggleMobileMenu">{{ $t('lightbox')
                                        }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'elements'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li>
                                        <router-link to="/elements/jumbotron" @click="toggleMobileMenu">{{ $t('jumbotron')
                                        }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/elements/pagination" @click="toggleMobileMenu">{{ $t('pagination')
                                        }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/elements/typography" @click="toggleMobileMenu">{{ $t('typography')
                                        }}</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'datatables'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li>
                                        <router-link to="/datatables/advanced" @click="toggleMobileMenu">{{ $t('advanced')
                                        }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/datatables/checkbox" @click="toggleMobileMenu">{{ $t('checkbox')
                                        }}</router-link>
                                    </li>
                                    <li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'forms'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li>
                                        <router-link to="/forms/input-group" @click="toggleMobileMenu">{{ $t('input_group')
                                        }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/forms/validation" @click="toggleMobileMenu">{{ $t('validation')
                                        }}</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/forms/input-mask" @click="toggleMobileMenu">{{ $t('input_mask')
                                        }}</router-link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <router-link to="/forms/file-upload" @click="toggleMobileMenu">{{ $t('file_upload')
                                        }}</router-link>
                                    </li>
                                    <li>
