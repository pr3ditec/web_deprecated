            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                ...
                <li class="menu nav-item">
                    <button
                        type="button"
                        class="nav-link group w-full"
                        :class="{ active: activeDropdown === 'Schedule' }"
                ...
                <li class="menu nav-item">
                    ...
                    <vue-collapsible :isOpen="activeDropdown === 'register'">
                        <ul class="sub-menu text-gray-500">
                            <li>
                                <router-link to="/secretaria" @click="toggleMobileMenu()">{{ $t("Secretaria") }}</router-link>
                            </li>
                            <li>
                                <router-link to="/clinica" @click="toggleMobileMenu()">{{ $t("Clinica") }}</router-link>
                            </li>
                        </ul>
                    </vue-collapsible>
                </li>
                ...
                <li class="menu nav-item">
                    <button
                        type="button"
                        class="nav-link group w-full"
                        :class="{ active: activeDropdown === 'relatorio' }"
                        @click="activeDropdown === 'relatorio' ? (activeDropdown = null) : (activeDropdown = 'relatorio')"
                    >
                        <div class="flex items-center">
                            <svg
                                class="group-hover:!text-primary shrink-0"
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark capitalize">
                                {{ $t("report") }}
                            </span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'relatorio' }">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    ...
                    <vue-collapsible :isOpen="activeDropdown === 'relatorio'">
                        <ul class="sub-menu text-gray-500">
                            <li>
