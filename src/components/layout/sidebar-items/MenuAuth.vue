...
<template>
    <TitleDivision title="authentication" />
        ...
        <vue-collapsible :isOpen="activeDropdown === 'authentication'">
            <ul class="sub-menu text-gray-500">
                <li @click="toggleMobileMenu">
                    <router-link to="/auth/login" target="_blank">{{
                        $t("login")
                    }}</router-link>
                </li>
                <li @click="toggleMobileMenu">
                    <router-link to="/auth/register" target="_blank">{{
                        $t("register")
                    }}</router-link>
                </li>
                <li @click="toggleMobileMenu">
                    <router-link to="/auth/lockscreen" target="_blank">{{
                        $t("unlock")
                    }}</router-link>
                </li>
                <li @click="toggleMobileMenu">
