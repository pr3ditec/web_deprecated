...
<template>
    <TitleDivision title="user_interface" />
    ...
    <li class="menu nav-item">
        <button
            ...
            :class="{
                active: activeDropdown === 'components',
            }"
            @click="
            ...
            <div
                ...
                :class="{
                    '!rotate-90': activeDropdown === 'components',
                }">
                <svg
                    width="16"
                    height="16"
    ...
    <li class="menu nav-item">
        <button
            ...
            class="nav-link group w-full"
            :class="{
                active: activeDropdown === 'elements',
            }"
            @click="
            ...
            <div
                class="rtl:rotate-180"
                :class="{
                    '!rotate-90': activeDropdown === 'elements',
                }">
                <svg
                    width="16"
                    height="16"
